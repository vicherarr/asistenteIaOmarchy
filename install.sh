...
echo "  2. Presiona SUPER + Z para arrancar el asistente bajo demanda."
echo "     (Esto iniciará el servicio systemd de forma automática y transparente)"
echo "  3. Presiona SUPER + X para detener el asistente por completo."
echo ""
echo "Nota: El servicio systemd se ha configurado para NO arrancar por defecto en el inicio."
echo "Si alguna vez deseas que se inicie automáticamente al encender el equipo, ejecuta:"
echo "  systemctl --user enable asistenteia.service"